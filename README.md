***THE FULL LENGTH FINAL EXAM IS LISTED BELOW, THIS WAS DONE FOR MY OWN SAKE***
...
A full-stack Travel Journal App with:

- Backend: .NET 6 Web API + EF Core + MySQL
- Frontend: ReactJS + Tailwind CSS
- Dockerized with `docker-compose`

## How to Run
 I got some errors but the end product should be able to run through docker.

docker-compose up --build

----------------------------------------------------------------------------------------------------------------------------------------
Skip to content
allanbarcelos/tt4-final-exam-2160_2025050108001200.md Secret
Last active 4 hours ago • Report abuse
Clone this repository at &lt;script src=&quot;https://gist.github.com/allanbarcelos/9ea1effa698374f01f0c9e5bdb8f38cb.js&quot;&gt;&lt;/script&gt;
<script src="https://gist.github.com/allanbarcelos/9ea1effa698374f01f0c9e5bdb8f38cb.js"></script>
Code
Revisions
4
tt4-final-exam-2160_2025050108001200.md
TT4 - 2160
...
Repository name: tt4-final-exam-simulation-v2
